...
public class ContextUtil implements CustomContext {
    private static final String GIT_IGNORE_HEADER = """
            ##
            ## NOTICE: Ignored files will be re-generated by DataSpray tool and all modifications will be lost.
            ## If you want to preserve a file and check it into source control, create a separate git ignore file
            ## and add an exception to explicitly not ignore that file. Do not add the exception to this file!
            ##
    ...
    public Object get(String name) throws Exception {
        return switch (name) {
            ...
            case "gitIgnoreHeader" -> GIT_IGNORE_HEADER;
